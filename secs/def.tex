...
\begin{frame}[t]
  ...
  \end{defn}}
  \only<3>{\begin{block}{Teorema (Balogh-Bonk, 2001)}\begin{itshape} Sia $\Omega$ un dominio limitato e strettamente pseudoconvesso, e sia $k_{\Omega}$ la distanza di Kobayashi su $\Omega$. Allora $(\Omega,k_{\Omega})$ è Gromov-iperbolico, e il bordo iperbolico $\partial_G\Omega$ può essere identificato con il bordo euclideo $\partial\Omega$.
...
\begin{frame}[t]
  ...
  \begin{block}{Corollario (Abate, 1991)}\begin{itshape}
    ...
    \begin{enumerate}
      \item le orbite di $f$ sono limitate; oppure,
