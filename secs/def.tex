\begin{frame}
  \frametitle{Derivata iperbolica}
  ...
  \end{defn}
  \pause
  Per il lemma di Schwarz-Pick, $|f^h(w)| \le 1$ per ogni $w \in \mathbb{D}$; inoltre, vale l'uguaglianza in qualche punto se e solo se $f \in \text{Aut}(\mathbb{D})$ e allora vale sempre l'uguaglianza.
\end{frame}
