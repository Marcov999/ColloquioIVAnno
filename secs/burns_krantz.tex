\begin{frame}[t]
  ...
  \only<4>{$$\lim_{n \longrightarrow +\infty} \frac{\bigl(1+|f^h(0)|\bigr)(1+|z_n|)^2}{\bigl(1-|f^h(0)|\bigr)\bigl(1+|f^h(z_n)|\bigr)}=\frac{2\bigl(1+|f^h(0)|\bigr)}{1-|f^h(0)|} < +\infty,$$
  contraddizione. \qed}
\end{frame}
...
\begin{frame}[t]
  ...
  \end{thm}}
  \only<2-4>{\textit{Traccia della dimostrazione:} senza perdita di generalità $\sigma=1$.} \only<3-4>{ Dalla Proposizione sui limiti non tangenziale segue che
