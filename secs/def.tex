...
\begin{frame}[t]
  ...
  \only<2-4>{
  Karlsson, 2001: sotto opportune ipotesi, che sono soddisfatte dagli spazi Gromov-iperbolici, valgono dei risultati simili per funzioni $1$-lipschitziane dallo spazio in sé. \%L'assioma 1 del paper è soddisfatto da tutti gli spazi iperbolici? Mi pare che sia soddisfatto dai nostri domini
  }
